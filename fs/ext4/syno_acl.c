 ...
 */
static size_t
ext4_xattr_list_syno_acl_access(struct inode *inode, char *list, size_t list_len,
...
static int
ext4_xattr_get_syno_acl(struct inode *inode, const char *name, void *buffer,
		   size_t size)
{
	struct syno_acl *acl;
	int error;
...
static int
ext4_xattr_set_syno_acl(struct inode *inode, const char *name, const void *value,
