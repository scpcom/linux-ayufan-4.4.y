...
#define MDC_MDIO_WRITE(preamableLength, phyID, regID, data) rtk_mdio_write(preamableLength, phyID, regID, data)
#define MDC_MDIO_READ(preamableLength, phyID, regID, pData) rtk_mdio_read(preamableLength, phyID, regID, rData)
