...
int comcerto_exp_values[5][7]= {
	...
	{0, (EXP_BUS_REG_BASE_CS4 >> 12), ((EXP_BUS_REG_BASE_CS4 + EXP_CS4_SEG_SIZE - 1) >> 12), EXP_NAND_MODE|EXP_MEM_BUS_SIZE_8, 0x02024004, 0x01010101, 0x00000001},	/* NAND: TODO Values to check */
};
