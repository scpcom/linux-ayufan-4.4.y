...
#include <mach/hardware.h>
	...
	#define COMCERTO_IRQ_FALLING_EDGE_GPIO	(C2K_GPIO_2 | C2K_GPIO_0) // [FIXME]
	#define COMCERTO_IRQ_LEVEL_GPIO 	C2K_GPIO_2 // [FIXME]
	...
	#define COMCERTO_NAND_BR		C2K_GPIO_6
	#define COMCERTO_NAND_CE		C2K_GPIO_29
	#define COMCERTO_NAND_ALE		C2K_GPIO_30
	#define COMCERTO_NAND_CLE		C2K_GPIO_31
