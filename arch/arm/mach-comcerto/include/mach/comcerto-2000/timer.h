...
#define COMCERTO_PWM_CLOCK_DIVIDER_CONTROL	APB_VADDR(COMCERTO_APB_TIMER_BASE + 0x8000)
#define COMCERTO_PWM_CURRENT_EVENT			APB_VADDR(COMCERTO_APB_TIMER_BASE + 0x8004)
...
#define COMCERTO_PWM5_ENABLE_MAX            APB_VADDR(COMCERTO_APB_TIMER_BASE + 0x8030)
#define COMCERTO_PWM5_LOW_DUTY_CYCLE        APB_VADDR(COMCERTO_APB_TIMER_BASE + 0x8034)
