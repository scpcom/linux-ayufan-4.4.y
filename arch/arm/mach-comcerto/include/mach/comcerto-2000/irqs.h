...
#define C2K_IRQ_UART0		LSPI_IRQ(26)
#define C2K_IRQ_UART1		LSPI_IRQ(27)
#define C2K_IRQ_UART_S2		LSPI_IRQ(27)
#define C2K_IRQ_SPI			LSPI_IRQ(28)
#define C2K_IRQ_SPI_LS		LSPI_IRQ(29)
#define C2K_IRQ_I2C			LSPI_IRQ(30)
